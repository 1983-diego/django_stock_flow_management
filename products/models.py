...
class Product(models.Model):
    ...
    category = models.ForeignKey(Category, on_delete=models.PROTECT, related_name='procucts')
    brand = models.ForeignKey(Brand, on_delete=models.PROTECT, related_name='procucts')
